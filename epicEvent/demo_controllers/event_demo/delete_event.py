...
delete_event_url = 'http://127.0.0.1:8000/api/event/18'  
...
if response.status_code in [200, 204]:  
    console.print("Event deleted successfully.", style="bold green")
else:
    console.print(f"Failed to delete event. Status code: [bold red]{response.status_code}[/bold red] - {response.text}", style="bold red")
