...
class UserController:
    ...
    def user_menu(self):
        ...
        self.console.print("1. Add new user\n2. Update user\n3. Delete user\n4. User List\n5. Back to menu", style="bold yellow")
    ...
    def create_user(self):
        ...
        if response.status_code in [200, 201]:
            ...
            self.console.print("User created successfully.", style="bold green")
    ...
    def update_user(self):
        ...
        update_url = f'http://127.0.0.1:8000/api-auth/users/{user_id}/update/'
        headers = {
            'Authorization': f'Bearer {jwt_token}',
        ...
        response = requests.patch(update_url, headers=headers, json=user_data)
        if response.status_code == 200:
    ...
    def delete_user(self):
        ...
        if jwt_token is None:
            ...
            return
        user_id= input("User ID : ")
        delete_user_url = f'http://127.0.0.1:8000/api-auth/users/{user_id}/delete/'
        headers = {
        'Authorization': f'Bearer {jwt_token}'
        }
        ...
        if response.status_code in [200, 204]:
            self.console.print("User deleted successfully.", style="bold green")
        else:
