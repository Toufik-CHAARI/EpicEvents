...
class TestSupportUserAccess:
    ...
    def test_support_user_cannot_update_user(self):
        ...
        update_data = {"username": "updateduser", "role": "commercial"}
...
class TestSupportUserContractAccess:
    ...
    def test_support_user_cannot_update_contract(self):
        url = reverse(
            "contract-detail", kwargs={"pk": self.sample_contract.pk}
        )
        update_data = {
            "is_signed": "false",
        }
...
class TestSupportUserEventAccess:
    ...
    def test_support_user_can_update_assigned_event(self):
        url = reverse(
            "event-detail", kwargs={"pk": self.assigned_event.pk}
        )
        update_data = {
            "attendees": 500,
        }
    ...
    def test_support_user_cannot_update_unassigned_event(self):
        url = reverse(
            "event-detail", kwargs={"pk": self.unassigned_event.pk}
        )
        update_data = {
            "location": "Acapulco",
        }
